...
variables
{
  /* ===== EDIT ONLY THESE SIX LINES BEFORE TEST ===== */

  int sys1 = 4;   // CAN1: 0=None 1=EBB 2=EMB 3=48V 4=EPAS
  int sys2 = 0;   // CAN2
  int sys3 = 0;   // CAN3
  int sys4 = 0;   // CAN4
  int sys5 = 0;   // CAN5
...
on start
{
  ...
  write("========================================");
  write("3 MINUTE MASTER TEST START");
  ...
  /* Measurement remains running for 3 minutes
     so Logging blocks can be checked. */
...
/* =========================================================
   CHANNEL START
   Initial state = OFF for 5 seconds
   ========================================================= */
...
/* =========================================================
   100 ms CONTROL MESSAGE TRANSMISSION
   ========================================================= */
...
/* =========================================================
   ISOLATION
   48V never calls these functions.
   ========================================================= */
...
/* =========================================================
   ...
   Force every active system OFF before stopping.
   ========================================================= */

on timer testTimer
{
  write("========================================");
  write("3 MINUTES COMPLETE - FORCING FINAL OFF");
  write("========================================");
